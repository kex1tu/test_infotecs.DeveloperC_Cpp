...
bool test_1() {
  ...
  ASSERT_EQ(parse_log_level("DEBUG"), LogLevel::kDebug);
  ASSERT_EQ(parse_log_level("info"), LogLevel::kInfo);
  ASSERT_EQ(parse_log_level("WarnIng"), LogLevel::kWarning);
  ASSERT_EQ(parse_log_level("ERROR"), LogLevel::kError);
  ASSERT_EQ(parse_log_level("Unknown"), LogLevel::kUnknown);

  ASSERT_EQ(parse_log_level("INVALID"), std::nullopt);
  ASSERT_EQ(parse_log_level(""), std::nullopt);
  ASSERT_EQ(parse_log_level("d\n\0"), std::nullopt);
